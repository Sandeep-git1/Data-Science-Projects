...
Before starting work on Power BI:

1. Manually review the data and decide on the approximate number of pages you’ll need for your dashboard.
2. Create a rough layout using an online design tool such as **Canva** to visualize your ideas.
3. Recreate the design in Power BI, using your sketch as a reference.
4. Layout of the dashboard can be different from person to person.
5. Dashboards should be designed with the **client in mind**, focusing on their needs rather than personal preferences.
